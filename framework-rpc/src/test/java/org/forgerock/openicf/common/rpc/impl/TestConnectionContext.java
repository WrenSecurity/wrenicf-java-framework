...
public class TestConnectionContext<
        H extends RemoteConnectionHolder<TestConnectionGroup<H>,
        H,
        TestConnectionContext<H>>>
        implements RemoteConnectionContext<TestConnectionGroup<H>, H, TestConnectionContext<H>> {
